...
var cartCounter = document.querySelector('#cartCounter'); // function updateCart(pizza){
...
function updateCart(pizza, url, msg) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, pizza).then(function (res) {
    cartCounter.innerText = res.data.totalQty; // delete cart.items[res.data._id];
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51ItQJzSI7E28cZr7zphZj1CVQdtYpvTnBKI0q0dA9yL02GZItVGcwk9zdQyYvDxUwCKBfLU2XdbwHLx5OwHxCh6N00RzEHCVcU');
              ...
              paymentForm.addEventListener('submit', function (e) {
                ...
                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    formObject[key] = value; // console.log(key, value);
                  }
                } catch (err) {
                  _iterator.e(err);
                } finally {
